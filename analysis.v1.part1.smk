...
rule A01_15__plot_motif_for_control:
    input:
        ...
        reference_transcriptome_fasta_gz_filename="external/contigs/gencode.v32.transcripts.fa.gz"
    output:
        flag_A01_15=touch("result/A01_15__plot_motif_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/finished")
    params:
        temp_result_directory="result/A01_15__plot_motif_for_control/{DATASET_COLLECTION_NAME}/{DATASET_PHENOTYPE_COLLECTION_NAME}/temp_result_directory"
    threads:
        config["threads_motif_calling"]
    shell:
        """
